...
class DiaryFormPage extends StatefulWidget {
  DiaryFormPage({Key? key}) : super(key: key);

  @override
  State<DiaryFormPage> createState() => _DiaryFormState();
}

class _DiaryFormState extends State<DiaryFormPage> {
 String? name;
              ...
              Expanded(
                child: StreamBuilder(
                    stream: FirebaseFirestore.instance
                        ...
                        //.orderBy('id')
                        .where("category", isEqualTo: "แบบพิมพ์ ส.ค.ส./สมุดไดอารี่")
                        .snapshots(),
