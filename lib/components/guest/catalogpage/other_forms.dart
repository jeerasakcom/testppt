...
class OthersFormsPage extends StatefulWidget {
  OthersFormsPage({Key? key}) : super(key: key);

  @override
  State<OthersFormsPage> createState() => _OthersFormsPageState();
}

class _OthersFormsPageState extends State<OthersFormsPage> {
  String? name;
              ...
              Expanded(
                child: StreamBuilder(
                    stream: FirebaseFirestore.instance
                        ...
                        //.orderBy('id')
                        .where("category", isEqualTo: "แบบพิมพ์อื่นๆ")
                        .snapshots(),
