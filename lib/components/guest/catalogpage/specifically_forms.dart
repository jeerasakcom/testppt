...
class SpecificallyFormsPage extends StatefulWidget {
  SpecificallyFormsPage({Key? key}) : super(key: key);

  @override
  State<SpecificallyFormsPage> createState() => _SpecificallyFormsState();
}

class _SpecificallyFormsState extends State<SpecificallyFormsPage> {
  String? name;
              ...
              Expanded(
                child: StreamBuilder(
                    stream: FirebaseFirestore.instance
                        ...
                        //.orderBy('id')
                        .where("category", isEqualTo: "แบบพิมพ์สั่งพิมพ์เฉพาะ")
                        .snapshots(),
