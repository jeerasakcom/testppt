...
class GeneralGovernmentFormsPage extends StatefulWidget {
  GeneralGovernmentFormsPage({Key? key}) : super(key: key);

  @override
  State<GeneralGovernmentFormsPage> createState() => _GeneralGovernmentFormsPageState();
}

class _GeneralGovernmentFormsPageState extends State<GeneralGovernmentFormsPage> {
  String? name;
